...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal4);
        Button button_start = (Button) findViewById(R.id.button_back);
        button_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level4.this, GameMenuLevels.class);
        ...
        dialog.setContentView(R.layout.previewdialog4);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setCancelable(false);

        Button btncont = (Button)dialog.findViewById(R.id.buttoncont);
